...
rtrim(dtm.M_TP_CMUHSR0) HSR,
rtrim(dtm.M_TP_CMUHSR1) HSR2,
dtm.M_TP_CMIQC0 CUR,
...
where 
dtm.M_MX_REF_JOB = 29154
-- and dtm.M_NB in (10202622, 10565056, 10582333)
)

ORDER BY CTP, FGT, TYPO, EXP, REFS, GEN, GID
