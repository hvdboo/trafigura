...
left join MUREX_MX_OWNER.UDTB291_DBF mapDyn on (mapDyn.M__INDEX_ = 7988797 and (rtrim(pos.M_LABEL) = rtrim(mapDyn.M_SRCCOL) and (mapDyn.M_SRCTBL = '100' or  mapDyn.M_SRCTBL = '0')))
left join MUREX_MX_OWNER.UDTB291_DBF mapSim on (mapSim.M__INDEX_ = 7988808 and (rtrim(pos.M_LABEL) = rtrim(mapSim.M_SRCCOL) and (mapSim.M_SRCTBL = '100' or  mapSim.M_SRCTBL = '0')))

where pos.M_STRATID in (2080192)
