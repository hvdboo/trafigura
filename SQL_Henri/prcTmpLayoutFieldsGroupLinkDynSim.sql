...
max(case when pos.M_YCOORD = 1 and pos.M_INDEX = 0 then rtrim(mapDyn.T_COL) else null end) DYN1a,
max(case when pos.M_YCOORD = 1 and pos.M_INDEX = 1 then rtrim(mapDyn.T_COL) else null end) DYN1b,
max(case when pos.M_YCOORD = 1 and pos.M_INDEX = 2 then rtrim(mapDyn.T_COL) else null end) DYN1c,
'#',
...
left join TRAF_MAP mapDyn on (mapDyn.TYP = 1 and (rtrim(pos.M_LABEL) = rtrim(mapDyn.S_COL) and (mapDyn.S_TBL = '130' or  mapDyn.S_TBL = '0')))
