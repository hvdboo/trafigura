...
left join MUREX_MX_OWNER.UDTB291_DBF mapMxml on (mapMxml.M__INDEX_ = 7988809 and (rtrim(pos.M_LABEL) = rtrim(mapMxml.M_SRCCOL) and (mapMxml.M_SRCTBL = '100' or  mapMxml.M_SRCTBL = '0')))
left join MUREX_MX_OWNER.UDTB291_DBF mapFix on (mapFix.M__INDEX_ = 8084294 and (rtrim(pos.M_LABEL) = rtrim(mapFix.M_SRCCOL) and (mapFix.M_SRCTBL = '100' or  mapFix.M_SRCTBL = '0')))
