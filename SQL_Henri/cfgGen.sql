...
when  9 then rtrim(gen.M_CURRENCY0)
when 12 then rtrim(ind0.M_IND_LAB)
when 13 then rtrim(ind0.M_IND_LAB)
when 27 then rtrim(ind0.M_IND_LAB)
...
order by gin.M_INSTR_TYPE, gin.M_INSTR