...
altid.M_OBJ_INST OBJ_INST, 
--altid.M_OBJ_ID, altid.M_OBJ_DESC,
rtrim(gen.M_INSTR)      PLI,
...
left join RT_INSGN_DBF gen on altid.M_OBJ_ID = gen.M_GEN_NUM

where rtrim(altid.M_OBJ_CLASS) = 'MTqCB77870'

order by CLASS, PLI, OBJ_INST,
case 
