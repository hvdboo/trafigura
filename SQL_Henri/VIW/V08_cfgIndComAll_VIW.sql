drop view INDCOM_ALL_VIW;
create view INDCOM_ALL_VIW
(
M_ASSTYP,
M_ASSLAB,
M_INDCAT,
...
when 8 then 
    ...
    when 3 then rtrim(avr.M_UNDNDX)
/*    
        case und.M_RESET
...
left join VIW_ICMSPT_DBF bskspt1 on bsk.M_ICMUID1 = bskspt1.M_ICMUID
...
left join VIW_FCM_DBF    fcm on fwd.M_FCMUID = fcm.M_FCMUID
left join VIW_ICMSPT_DBF fcmspt on fcm.M_ICMUID = fcmspt.M_ICMUID
...
drop table VIW_ICMALL_DBF;
create table VIW_ICMALL_DBF as (select * from INDCOM_ALL_VIW);
