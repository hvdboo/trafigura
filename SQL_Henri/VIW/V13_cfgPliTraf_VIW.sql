drop view PLITRAF_VIW;
create view PLITRAF_VIW
(
M_FINASS,
M_COMATP,
M_COMASS,
...
coalesce(rtrim(mvfwdfcm0.M_MVSYMBOL), rtrim(mvfwdicm0.M_MVSYMBOL)) MV_CRV0,
coalesce(rtrim(mvfwdfcm1.M_MVSYMBOL), rtrim(mvfwdicm1.M_MVSYMBOL)) MV_CRV1,
-- SRD
case
...
left join CM_FUT_DBF   fcm on pli.M_BDYUID = fcm.M_REFERENCE and pli.M_FMLUID in (32, 16384) --and pli.M_VIN = fcm.M_VINFLT
...
left join KEYMAP_STC_DBF altfutpli on fcm.M_REFERENCE = altfutpli.M_OBJ_ID and rtrim(altfutpli.M_OBJ_CLASS) in ('MwOJI56899') and rtrim(altfutpli.M_OBJ_ASYS) = 'INSTRUMENT'
left join KEYMAP_STC_DBF altfwdpli on fcm.M_REFERENCE = altfutpli.M_OBJ_ID and rtrim(altfutpli.M_OBJ_CLASS) in ('MfHrf56898') and rtrim(altfutpli.M_OBJ_ASYS) in ('INSTRUMENT','INSTRUMENT_FWD')
left join KEYMAP_STC_DBF altoftpli on fcm.M_REFERENCE = altfutpli.M_OBJ_ID and rtrim(altfutpli.M_OBJ_CLASS) in ('MpHvX56898') and rtrim(altfutpli.M_OBJ_ASYS) in ('INSTRUMENT','INSTRUMENT_OFUT')
left join KEYMAP_STC_DBF altoappli on fcm.M_REFERENCE = altfutpli.M_OBJ_ID and rtrim(altfutpli.M_OBJ_CLASS) in ('McPlm56897') and rtrim(altfutpli.M_OBJ_ASYS) = 'INSTRUMENT'
...
-- MARKETVIEW
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,7) in ('COM_FUT')  and M_MXHSR not in ('LDM','SGM','TAM','TAPS','TAS') and M_MXDFL <> 'Dep') mvhisfcm  on rtrim(pli.M_PLILAB)  = rtrim(mvhisfcm.M_MXLABEL)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,7) in ('COM_FUT')  and M_MXHSR not in ('LDM','SGM','TAM','TAPS','TAS') and M_MXDFL <> 'Dep') mvhisfcm0 on rtrim(pli.M_CRVICM0) = rtrim(mvhisfcm0.M_MXLABEL)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,7) in ('COM_FUT')  and M_MXHSR not in ('LDM','SGM','TAM','TAPS','TAS') and M_MXDFL <> 'Dep') mvhisfwd0 on rtrim(pli.M_CRVFWD0) = rtrim(mvhisfwd0.M_MXLABEL)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,7) in ('COM_FUT')  and M_MXHSR not in ('LDM','SGM','TAM','TAPS','TAS') and M_MXDFL <> 'Dep') mvhisfcm1 on rtrim(pli.M_CRVICM1) = rtrim(mvhisfcm1.M_MXLABEL)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,8) in ('COM_SIND') and rtrim(M_MXHSR) not in (' ','PM') and M_MXDFL <> 'Dep') mvhisicm0 on rtrim(pli.M_CRVICM0) = rtrim(mvhisicm0.M_MXLABEL) and rtrim(pli.M_CRVQOT0) = rtrim(mvhisicm0.M_MXQLABEL)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,8) in ('COM_SIND') and rtrim(M_MXHSR) not in (' ','PM') and M_MXDFL <> 'Dep') mvhisicm1 on rtrim(pli.M_CRVICM1) = rtrim(mvhisicm1.M_MXLABEL) and rtrim(pli.M_CRVQOT1) = rtrim(mvhisicm1.M_MXQLABEL)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,8) in ('COM_CIND')) mvhisnby0 on rtrim(pli.M_UNDLAB0) = rtrim(mvhisnby0.M_MXLABEL)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXLABEL,  M_MXQLABEL, M_MXHSR, M_MVSYMBOL from UDTB344_DBF where substr(M_MXPTYPE,1,8) in ('COM_CIND')) mvhisnby1 on rtrim(pli.M_UNDLAB1) = rtrim(mvhisnby1.M_MXLABEL) 
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXCRVUND, M_MXQLABEL, M_MXVIN, M_MVSYMBOL from UDTB343_DBF where rtrim(M_MXPTYPE) in ('COM_ADJ_FUT','COM_ADJ_FUT1','COM_FUT','COM_FUT_3M')) mvfwdfcm0 on rtrim(pli.M_CRVICM0) = rtrim(mvfwdfcm0.M_MXCRVUND) and rtrim(mvfwdfcm0.M_MXVIN) = rtrim(pli.M_VIN)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXCRVUND, M_MXQLABEL, M_MXVIN, M_MVSYMBOL from UDTB343_DBF where rtrim(M_MXPTYPE) in ('COM_ADJ_FUT','COM_ADJ_FUT1','COM_FUT','COM_FUT_3M')) mvfwdfcm1 on rtrim(pli.M_CRVICM1) = rtrim(mvfwdfcm1.M_MXCRVUND) and rtrim(mvfwdfcm1.M_MXVIN) = rtrim(pli.M_VIN)
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXCRVUND, M_MXQLABEL, M_MXVIN, M_MVSYMBOL from UDTB343_DBF where rtrim(M_MXPTYPE) in ('COM_ADJ_SWAP','COM_ADJ_SWAP1','COM_SWAP') and (rtrim(M_MXTENOR) is null or rtrim(M_MXTENOR) = 'Spot') and M_MXDFL <> 'Dep') mvfwdicm0 on rtrim(pli.M_CRVICM0) = rtrim(mvfwdicm0.M_MXCRVUND) and rtrim(pli.M_CRVQOT0) = rtrim(mvfwdicm0.M_MXQLABEL) 
left join (select distinct M_MXPTYPE, M_MXPUB, M_MXCRVUND, M_MXQLABEL, M_MXVIN, M_MVSYMBOL from UDTB343_DBF where rtrim(M_MXPTYPE) in ('COM_ADJ_SWAP','COM_ADJ_SWAP1','COM_SWAP') and (rtrim(M_MXTENOR) is null or rtrim(M_MXTENOR) = 'Spot') and M_MXDFL <> 'Dep') mvfwdicm1 on rtrim(pli.M_CRVICM1) = rtrim(mvfwdicm1.M_MXCRVUND) and rtrim(pli.M_CRVQOT1) = rtrim(mvfwdicm1.M_MXQLABEL) 
...
drop table VIW_PLITRAF_DBF;
create table VIW_PLITRAF_DBF as (select * from PLITRAF_VIW);