drop view INDCOM_NBY_VIW;
create view INDCOM_NBY_VIW
(
M_ASSTYP,
M_ASSLAB,
M_INDCAT,
...
left join (select distinct M_ICMUID, M_PUB, M_HSRDFL, M_CAL, M_UOQ, M_UOD, M_PHYLAB, M_LOCLAB, M_PHYUID, M_LOCUID, M_QOTUID, M_QOTFWDUID from VIW_ICMSPT_DBF where M_QOTUID = M_QOTFWDUID) nbyfccgenicmviw on nbyfccgenicm.M_REFERENCE = nbyfccgenicmviw.M_ICMUID
...
left join (select distinct M_ICMUID, M_PUB, M_HSRDFL, M_CAL, M_UOQ, M_UOD, M_PHYLAB, M_LOCLAB, M_PHYUID, M_LOCUID, M_QOTUID, M_QOTFWDUID from VIW_ICMSPT_DBF where M_QOTUID = M_QOTFWDUID) nbyfccgenucmviw on nbyfccgenucm.M_REFERENCE = nbyfccgenucmviw.M_ICMUID
...
left join (select distinct M_ICMUID, M_PUB, M_HSRDFL, M_CAL, M_UOQ, M_UOD, M_PHYLAB, M_LOCLAB, M_PHYUID, M_LOCUID, M_QOTUID, M_QOTFWDUID from VIW_ICMSPT_DBF where M_QOTUID = M_QOTFWDUID) nbyfcsgenicmviw on nbyfcsgenicm.M_REFERENCE = nbyfcsgenicmviw.M_ICMUID
...
left join (select distinct M_ICMUID, M_PUB, M_HSRDFL, M_CAL, M_UOQ, M_UOD, M_PHYLAB, M_LOCLAB, M_PHYUID, M_LOCUID, M_QOTUID, M_QOTFWDUID from VIW_ICMSPT_DBF where M_QOTUID = M_QOTFWDUID) nbyfcsgenucmviw on nbyfcsgenucm.M_REFERENCE = nbyfcsgenucmviw.M_ICMUID
...
left join (select distinct M_ICMUID, M_PUB, M_HSRDFL, M_CAL, M_UOQ, M_UOD, M_PHYLAB, M_LOCLAB, M_PHYUID, M_LOCUID, M_QOTUID, M_QOTFWDUID from VIW_ICMSPT_DBF where M_QOTUID = M_QOTFWDUID) nbyfcsgenundicmviw on nbyfcsgenundicm.M_REFERENCE = nbyfcsgenundicmviw.M_ICMUID
...
left join (select distinct M_ICMUID, M_PUB, M_HSRDFL, M_CAL, M_UOQ, M_UOD, M_PHYLAB, M_LOCLAB, M_PHYUID, M_LOCUID, M_QOTUID, M_QOTFWDUID from VIW_ICMSPT_DBF where M_QOTUID = M_QOTFWDUID) nbyicmviw on nbyicm.M_REFERENCE = nbyicmviw.M_ICMUID
...
drop table VIW_ICMNBY_DBF;
create table VIW_ICMNBY_DBF as (select * from INDCOM_NBY_VIW);
