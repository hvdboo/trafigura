...
--and (rtrim(trn.M_BPFOLIO) = 'OTEX HHA TEZD' or rtrim(trn.M_SPFOLIO) = 'OTEX HHA TEZD')
...
trn.M_TRN_FMLY, atp.M_LABEL, ass.M_LABEL, phy.M_LABEL

order by OWNER, PFL, FINASS, ASSTYP, ASSLAB, PHY