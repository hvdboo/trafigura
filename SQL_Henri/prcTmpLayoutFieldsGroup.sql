...
max(case  
when pos.M_ATTRIB = 1  then 'P'
when pos.M_ATTRIB = 4  then 'A'
when pos.M_ATTRIB > 15 then 'H' else null end) ATR
from NP_POS_DBF pos 
...
--where pos.M_STRATID = ${LAY}
--where pos.M_STRATID = &LAYOUTID
where patObj.M_ITEM_ID = 2157 and pos.M_ATTRIB < 15
