...
left join MUREX_MX_OWNER.UDTB291_DBF mapFix on (mapFix.M__INDEX_ = 8084294 and (rtrim(pos.M_LABEL) = rtrim(mapFix.M_SRCCOL) and (mapFix.M_SRCTBL = '146' or  mapFix.M_SRCTBL = '0')))
