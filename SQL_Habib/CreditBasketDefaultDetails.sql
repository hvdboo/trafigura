...
select TT1.M_LABEL as CreditBasketName, 
case when (TT7.M_TYPE=0) then 'Bond'
	when (TT7.M_TYPE=1) then 'Issuer'
	when (TT7.M_TYPE=2) then 'Basket'
end as Type,  
...
------
------
from CR_BSKH_DBF TT1, CR_BSKB_DBF TT2 , SE_HEAD_DBF TT3, TRN_CPDF_DBF TT4,CR_BSK_DD_DBF TT5, CR_DD_DBF TT6, CR_ENTITY_DBF TT7,
------
/* ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* DefaultDetails*/
...
and TT1.M_B_NATURE=0  
and TT7.M_SECURITY = TT3.M_SE_D_LABEL (+)  
and TT7.M_ISSUER = TT4.M_LABEL (+)
and TT7.M_B_ENT_UID = TT5.M_B_ENT_UID
and TT5.M_DFLTD_UID =TT6.M_UID (+) 
and TT2.M_B_ENT_UID = TT7.M_B_ENT_UID (+) 
