...
set linesize 400;
set pagesize 2048;
select	T1.M_IND_LAB as EquityIndex_Indices ,
	case	when (T1.M_CATEGORY  = 1 ) then 'Equity price' end as Category,
	...
	T3.M_SE_D_LABEL as Underlying, CAST(T1.M_RT_MKT AS VARCHAR2(18)) as UnderlyingMarket,  T2.M_GRP_DESC as ArchivingGroup, 
