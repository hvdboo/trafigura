...
set linesize 4500;
set pagesize 2048;
select  T1.M_INSTR as RepoTemplate,
...
case when (T2.M_ECP_TYPE1 = 0) then 'Driving schedule' 
	...
	CAST(T2.M_ECP1 AS VARCHAR2(18)) as CalcStartSch3Fees,
	...
	CAST(T2.M_ALT_YLCNV0 AS VARCHAR(25)) as AlternateYieldConvention,
